...
- Units: pixels
- Canvas size: dynamic — fills `#game-window` (mobile: full `100dvh` viewport; desktop: centered portrait frame), recalculated on resize/orientation/`visualViewport` change
...
No audio system currently implemented. (Note: master branch includes procedural Web Audio soundtrack.)
...
- 2026-09-04 — Mobile fullscreen viewport sizing (100dvh) + README; game brought onto main-lineage PR branch
